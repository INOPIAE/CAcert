...
class L10n {
	 ...
	 * 		sets the language for a mail that is receveid by a user in his defifined language.
	 *		assurer language is French, assuree language is German,
	 *		the mail to the assurer is sent in French and to the assuree in German
	 * @param mixed $accountid
	 * 		the user id of the account receiving a mail
	 * @return
	 */
