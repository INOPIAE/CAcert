...
<? } ?>
    <div class="relatedLinks">
      ...
      <ul class="menu" id="WoT">
        <li><a href="wot.php?id=0"><?=_("About")?></a></li>
        <li><a href="wot.php?id=12"><?=_("Find an Assurer")?></a></li>
        <li><a href="wot.php?id=3"><?=_("Rules")?></a></li>
        <li><? if($_SESSION['profile']['assurer'] != 1) { ?><a href="wot.php?id=2"><?=_("Becoming an Assurer")?></a><? } else { ?><a href="wot.php?id=5"><?=_("Assure Someone")?></a><? } ?></li>
        <li><a href="wot.php?id=4"><?=_("Trusted ThirdParties")?></a></li>
        <? if($_SESSION['profile']['points'] >= 500) { ?><li><a href="wot.php?id=11"><div class="nowrap"><?=_("Organisation Assurance")?></div></a></li><? } ?>
      </ul>
    </div>
    <div class="relatedLinks">
...
?>
	...
	<? /* <li><div class="nowrap"><a href="/ttp.php<?=$extra?>">A4 - <?=_("TTP Form")?></a></div></li>
	 <li><div class="nowrap"><a href="/ttp.php<?=$extra?>&amp;format=letter">US - <?=_("TTP Form")?></a></div></li> */
	?>
	 <? if($_SESSION['profile']['points'] > 100) { ?><li><div class="nowrap"><a href="/cap.php<?=$extra2?>">A4 - <?=_("Assurance Form")?></a></div></li>
	 <li><div class="nowrap"><a href="/cap.php<?=$extra2?>&amp;format=letter">US - <?=_("Assurance Form")?></a></div></li>
	 <? } ?>
	 <? /*
	  <li><div class="nowrap"><a href="/ttp.php">A4 - <?=_("Blank TTP Form")?></a></div></li>
	  <li><div class="nowrap"><a href="/ttp.php?&amp;format=letter">US - <?=_("Blank TTP Form")?></a></div></li>
	 */ ?>
	 <li><div class="nowrap"><a href="/cap.php">A4 - <?=_("Blank CAP Form")?></a></div></li>
	 <li><div class="nowrap"><a href="/cap.php?&amp;format=letter">US - <?=_("Blank CAP Form")?></a></div></li></ul>
    </div>
